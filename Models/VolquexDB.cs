...
namespace Volquex.Models
{
    ...
    public partial class VolquexDB : LinqToDB.Data.DataConnection
    {
        ...
        public ITable<Notificaciones> Notificaciones { get { return this.GetTable<Notificaciones>(); } }
        ...
        public ITable<Usuarios_Disp> Usuarios_Disp { get { return this.GetTable<Usuarios_Disp>(); } }
        public ITable<Usuarios_Loc> Usuarios_Loc { get { return this.GetTable<Usuarios_Loc>(); } }
        public ITable<Usuarios_Mat> Usuarios_Mat { get { return this.GetTable<Usuarios_Mat>(); } }
        ...
        public ITable<Viajes_Volq_Mat> Viajes_Volq_Mat { get { return this.GetTable<Viajes_Volq_Mat>(); } }
    ...
    public partial class Estados
    {
        ...
        [Column, Nullable] public string EstElegible { get; set; } // integer
    ...
    [Table(Schema = "public", Name = "notificaciones")]
    public partial class Notificaciones
    {
        [PrimaryKey, Identity] public decimal NotificacionId { get; set; } // string
        [Column, NotNull] public DateTime NotFchHr { get; set; } // integer
        [Column, NotNull] public decimal ViajeId { get; set; } // integer
        [Column, NotNull] public decimal UsuarioId { get; set; } // integer
        [Column, NotNull] public string DispositivoId { get; set; } // integer
        [Column, NotNull] public string NotMensaje { get; set; } // integer
        [Column, NotNull] public string NotRespuesta { get; set; } // integer
        [Column, NotNull] public string NotEst { get; set; } // integer

        [Association(ThisKey = "ViajeId", OtherKey = "ViajeId", CanBeNull = false)]
        public Viajes fknotificacionesviaje { get; set; }

        [Association(ThisKey = "UsuarioId, DispositivoId", OtherKey = "UsuarioId, DispositivoId", CanBeNull = false)]
        public Usuarios_Disp fknotificacionesusuario { get; set; }
    }
    ...
    [Table(Schema = "public", Name = "usuarios_disp")]
    public partial class Usuarios_Disp
    {
        [PrimaryKey, NotNull] public decimal UsuarioId { get; set; } // numeric
        [Column, NotNull] public string DispositivoId { get; set; } // string precision
        [Column, NotNull] public DateTime UsuDispExpira { get; set; } // string precision

        #region Associations

        /// <summary>
        /// fk_usuarios_disp_usuario
        /// </summary>
        [Association(ThisKey = "UsuarioId", OtherKey = "UsuarioId", CanBeNull = false)]
        public Usuarios fkusuariosdispusuario { get; set; }
    ...
    [Table(Schema = "public", Name = "usuarios_mat")]
    public partial class Usuarios_Mat
    {
        [PrimaryKey, NotNull] public decimal UsuarioId { get; set; } // numeric
        [PrimaryKey, NotNull] public decimal MaterialId { get; set; } // numeric
        [Column, NotNull] public decimal UsuMatPrecio { get; set; } // numeric
        ...
        /// </summary>
        [Association(ThisKey = "UsuarioId", OtherKey = "UsuarioId", CanBeNull = false)]
        public Usuarios fkusuariosmatusuario { get; set; }
        
        /// <summary>
        /// fk_usuarios_mat_material
        /// </summary>
        [Association(ThisKey = "MaterialId", OtherKey = "MaterialId", CanBeNull = false)]
        public Materiales fkusuariosmatmaterial { get; set; }
    ...
    public partial class Viajes
    {
        ...
        public int ConducCalificacion { get; set; }
        ...
        public Viajes_Bit[] Bitacora { get; set; }
    ...
    public partial class Viajes_Bit
    {
        ...
        [Column, NotNull] public string ViaBitTipo { get; set; }
        [Column] public string ViaBitInfo { get; set; }
    ...
    public partial class Viajes_Volq
    {
        ...
        [Column] public string ViaVolqTipoDscto { get; set; } // character varying(1)
        [Column] public decimal ViaVolqDscto { get; set; } // money
        ...
        [Column, NotNull] public decimal ViaVolqTotalMateriales { get; set; } // character varying(1)
        ...
        /// <summary>
        /// fk_viajes_volq_mat_1_BackReference
        /// </summary>
        [Association(ThisKey = "ViajeId, ViajeVolquetaId", OtherKey = "ViajeId, ViajeVolquetaId", CanBeNull = false)]
        public IEnumerable<Viajes_Volq_Mat> Materiales { get; set; }

        #endregion
    }

    [Table(Schema = "public", Name = "viajes_volq_mat")]
    public partial class Viajes_Volq_Mat
    {
        [PrimaryKey, NotNull] public decimal ViajeId { get; set; } // numeric
        [Column, NotNull] public decimal ViajeVolquetaId { get; set; } // numeric
        [Column, NotNull] public decimal MaterialId { get; set; } // numeric
        [Column, NotNull] public decimal ViaVolqMatPrecio { get; set; } // numeric
        [Column, NotNull] public decimal ViaVolqMatCantidad { get; set; } // numeric

        #region Associations

        /// <summary>
        /// fk_viajes_volq_mat_viaje
        /// </summary>
        [Association(ThisKey = "ViajeId, ViajeVolquetaId", OtherKey = "ViajeId, ViajeVolquetaId", CanBeNull = false)]
        public Viajes_Volq Oferta { get; set; }
        
        /// <summary>
        /// fk_viajes_volq_mat_material
        /// </summary>
        [Association(ThisKey = "MaterialId", OtherKey = "MaterialId", CanBeNull = false)]
